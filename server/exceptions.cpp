...
void FindModuleName(DWORD dwAddr, PCHAR sz)
{
	HANDLE        hModuleSnap = NULL;
	MODULEENTRY32 me32;
	...
	do
	{
		if (dwAddr >= (DWORD)me32.modBaseAddr && dwAddr <= (DWORD)(me32.modBaseAddr + me32.modBaseSize))
		{
...
void DumpCrashInfo(char * szFileName)
{
	...
	FindModuleName(pContextRecord->Eip, szModuleName);
